...
if (!SVGGraphicsElement.prototype.transformedBBox || !SVGGraphicsElement.prototype.transformedBBoxContains) {
    [pointInTransformedBBox,
	 ...
	 const get_transform_matrix = function (elem) {
	...
	const transformRelative = function (m,t) {
	    return [
		m.a*t[0]+m.c*t[1],
		m.b*t[0]+m.d*t[1]
	    ]
	...
	const transformAbsolute = function (m,t) {
	    return [
		m.a*t[0]+m.c*t[1]+m.e,
		m.b*t[0]+m.d*t[1]+m.f
	    ]
	...
	const pointInTransformedBBox = function ([x,y],{r,a,b}) {
	    const d = [x-r[0],y-r[1]];
